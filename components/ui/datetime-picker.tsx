      ...
      <PopoverContent className="w-auto p-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-row-reverse items-center justify-between">
            <Button className="ms-2 h-7 px-2" type='button' onClick={onSubmit}>
              选 择
            </Button>
            {timezone && (
...
function MonthYearPicker({
  ...
  const months = useMemo(() => {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      months.push({ value: i, label: format(new Date(0, i), 'MMM', { locale: zhCN }), disabled });
    }
    return months;
  }, [value]);
