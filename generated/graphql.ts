...
export type MenusQuery = { menus: Array<{ id: number, name: string, display_name?: string | null, description?: string | null, path?: string | null, component?: string | null, redirect?: string | null, meta?: string | null, parent_id: number, sort_id: number, children?: Array<{ id: number, name: string, display_name?: string | null, description?: string | null, path?: string | null, component?: string | null, redirect?: string | null, meta?: string | null, parent_id: number, sort_id: number, children?: Array<{ id: number, name: string, display_name?: string | null, description?: string | null, path?: string | null, component?: string | null, redirect?: string | null, meta?: string | null, parent_id: number, sort_id: number }> | null }> | null }> };
